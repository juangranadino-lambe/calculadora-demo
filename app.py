...
# 3. DIVISIÓN PRINCIPAL: Las columnas AHORA SON las cajas verdes
...
# ==========================================
with col_izq:
    st.markdown("<h3 style='margin-top:0;'>⚙️ Datos a introducir</h3>", unsafe_allow_html=True)
    st.write("")
    ...
    st.markdown("<hr style='border-top: 2px solid #22c55e;'>", unsafe_allow_html=True)
