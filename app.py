...
# 2. LA MAGIA DEFINITIVA (Borde, Fondo y Estiramiento al 100%)
st.markdown("""
<style>
    .block-container {
        padding-top: 2rem;
    ...
    /* Obligamos a las columnas a estirarse a la misma altura */
    [data-testid="column"] > div {
        height: 100%;
    }
    
    /* Diseño de las cajas oficiales de Streamlit */
    [data-testid="stVerticalBlockBorderWrapper"] {
        border: 4px solid #22c55e !important;
        background-color: #ebfef0 !important; /* Verde pastel clarito */
        border-radius: 15px !important;
        height: 100% !important; /* Llega hasta abajo del todo */
    }
    
    /* Quitamos el fondo blanco de Streamlit para que se vea nuestro verde */
...
# ==========================================
with col_izq:
    # Usamos el contenedor NATIVO (así no se escapan los botones fuera)
...
# ==========================================
with col_der:
    # Usamos el contenedor NATIVO para la derecha también
    with st.container(border=True):
        st.markdown("<h3 style='margin-top:0;'>💰 Resultados</h3>", unsafe_allow_html=True)
        
        # Inyectamos solo el texto, heredando el verde del contenedor
        html_resultados = f"""
