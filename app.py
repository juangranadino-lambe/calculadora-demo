...
# 2. CSS solo para ajustar márgenes y aprovechar pantalla
st.markdown("""
<style>
    .block-container {
        padding-top: 2rem;
...
# ==========================================
with col_izq:
    # Creamos nuestra propia caja visual con un div HTML
    st.markdown('<div style="border: 4px solid #22c55e; border-radius: 15px; background-color: #ebfef0; padding: 20px;">', unsafe_allow_html=True)
    ...
    st.markdown("<hr style='border-top: 2px solid #22c55e;'>", unsafe_allow_html=True) # Línea separadora gruesa y verde
    ...
    st.markdown('</div>', unsafe_allow_html=True) # Cerramos la caja HTML
...
# ==========================================
with col_der:
    # Usamos la misma técnica de caja HTML, sin trucos raros de cadenas
    html_resultados = f"""
    <div style="border: 4px solid #22c55e; border-radius: 15px; background-color: #ebfef0; padding: 20px; text-align: center;">
        <h3 style="margin-top: 0;">💰 Resultados</h3>
        <p style="color: #166534; font-size: 1.2rem; font-weight: bold; margin: 20px 0 0 0;">💶 COSTE UNITARIO</p>
